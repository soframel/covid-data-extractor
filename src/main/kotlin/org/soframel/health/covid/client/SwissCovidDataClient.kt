...
@ApplicationScoped
class SwissCovidDataClient {

    val logger = Logger.getLogger(SwissCovidDataClient::class.qualifiedName)

    @Inject
    @ConfigProperty(name = "org.soframel.health.covid.client.SwissCovidDataURL")
